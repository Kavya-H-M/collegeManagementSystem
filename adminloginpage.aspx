<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminloginpage.aspx.cs" Inherits="collegeManagementSystem.adminloginpage" %>
...
<body style="margin:0; height: 100vh;">
    ...
    <div>
      <div class="headtxt">ADMIN LOGIN</div>
        <div class="login">
            <div class="boxes">
               <table>
                    <tr>
     <td>EMAIL</td>
                        <td><input type="text" id="aemail" runat="server" /></td>
                        </tr>
                   <tr >
        <td style="padding-right:10px;">PASSWORD</td>
                       <td><input type="password" id="apswd" runat="server" /></td>
                       </tr>
                        </table>
